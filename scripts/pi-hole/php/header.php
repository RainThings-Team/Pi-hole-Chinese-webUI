...
<div>
    ...
    <div class="js-warn" id="js-warn-exit"><h1>JavaScript被关闭！</h1>该网站需要JavaScript才能正常运行。</p>
                ...
                <ul class="nav navbar-nav">
                    <li>
                        <a style="pointer-events:none;">
                            <span class="hidden-xs hidden-sm">主机名:</span>
                        ...
                        <ul class="dropdown-menu" style="right:0">
                            ...
                            <li class="user-body">
                                ...
                                <div class="col-xs-12 text-center" id="sessiontimer">
                                    <b>会话对 <span id="sessiontimercounter"><?php if($auth && strlen($pwhash) > 0){echo $maxlifetime;}else{echo "0";} ?></span>有效</b>
                                </div>
                            </li>
                            <!-- Menu Footer -->
                            <li class="user-footer">
                                ...
                                <div class="<?php if(!isset($core_commit) && !isset($web_commit)) { ?>hidden-md <?php } ?>hidden-lg">
                                    ...
                                    if($core_update){ ?> <a class="alert-link lookatme btn-link" href="https://github.com/pi-hole/pi-hole/releases" rel="noopener" target="_blank" style="background:none">(更新可用!)</a><?php } ?><br>
                                    <b>Web 接口版本 </b><?php
                                    echo $web_current;
                                    ...
                                    <b>FTL 版本 </b> <?php
                                    echo $FTL_current;
                                    if($FTL_update){ ?> <a class="alert-link lookatme btn-link" href="https://github.com/pi-hole/FTL/releases" rel="noopener" target="_blank" style="background:none">(更新可用!)</a><?php } ?><br><br>
                                </div>
                                */ ?>
                                <!-- PayPal -->
                ...
                <div class="pull-left info">
                    <p>状态</p>
                        ...
                        if ($pistatus == "1") {
                            ...
                            echo '<a id="status"><i class="fa fa-circle text-red"></i> DNS 服务没有运行</a>';
                        } else {
                        ...
                        {
                            echo '<a id=\"temperature\"><i class="fa fa-circle text-red"></i> FTL 已离线</a>';
                        }
                    ?>
                    <br/>
                    <?php
                    echo "<a title=\"检测到 $nproc 核心\"><i class=\"fa fa-circle ";
                        if ($loaddata[0] > $nproc) {
                            echo "text-red";
                        }
                        else
                    ...
                    echo "<a><i class=\"fa fa-circle ";
                        ...
                        if($memory_usage > 0.0)
                        {
                            echo "\"></i> 内存利用率:&nbsp;&nbsp;" . sprintf("%.1f",100.0*$memory_usage) . "&thinsp;%</a>";
                        }
                        else
                        {
                            echo "\"></i> 内存利用率:&nbsp;&nbsp; N/A</a>";
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview<?php if($scriptname === "db_queries.php" || $scriptname === "db_lists.php" || $scriptname === "db_graph.php"){ ?> active<?php } ?>">
                  <a href="#">
                    ...
                    <i class="fa fa-clock"></i> <span>所有数据</span>
                  </a>
                  <ul class="treeview-menu">
                    <li<?php if($scriptname === "db_graph.php"){ ?> class="active"<?php } ?>>
                        <a href="db_graph.php">
                            <i class="fa fa-file-alt"></i> <span>图表</span>
                        </a>
                    </li>
                ...
                <li class="treeview <?php if(in_array($scriptname, array("groups.php", "groups-clients.php", "groups-domains.php", "groups-adlists.php"))){ ?>active<?php } ?>">
                  <a href="#">
                    ...
                    <i class="fa fa-users-cog"></i> <span>Group 管理器</span>
                  </a>
                  <ul class="treeview-menu">
                    <li<?php if($scriptname === "groups.php"){ ?> class="active"<?php } ?>>
                        <a href="groups.php">
                            <i class="fa fa-user-friends"></i> <span>组</span>
                        </a>
                    </li>
                    ...
                    <li<?php if($scriptname === "groups-adlists.php"){ ?> class="active"<?php } ?>>
                        <a href="groups-adlists.php">
                            <i class="fa fa-shield-alt"></i> <span>广告屏蔽列表</span>
                        </a>
                    </li>
                  </ul>
                </li>
                ...
                <li id="pihole-disable" class="treeview"<?php if ($pistatus == "0") { ?> hidden="true"<?php } ?>>
                  <a href="#">
                    ...
                    <i class="fa fa-stop"></i> <span>停用&nbsp;&nbsp;&nbsp;<span id="flip-status-disable"></span></span>
                  </a>
                  <ul class="treeview-menu">
                    <li>
                        <a href="#" id="pihole-disable-permanently">
                            <i class="fa fa-stop"></i> <span>无限期停用</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-10s">
                            <i class="fa fa-clock"></i> <span>暂停10秒</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-30s">
                            <i class="fa fa-clock"></i> <span>暂停30秒</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-5m">
                            <i class="fa fas fa-clock"></i> <span>暂停5分钟</span>
                        </a>
                    </li>
                    <li>
                ...
                <li class="treeview <?php if(in_array($scriptname, array("gravity.php", "queryads.php", "auditlog.php", "taillog.php", "taillog-FTL.php", "debug.php"))){ ?>active<?php } ?>">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li<?php if($scriptname === "gravity.php"){ ?> class="active"<?php } ?>>
                        <a href="gravity.php">
                            <i class="fa fa-arrow-circle-down"></i> <span>更新屏蔽列表</span>
                        </a>
                    </li>
                    <!-- Query Lists -->
                    <li<?php if($scriptname === "queryads.php"){ ?> class="active"<?php } ?>>
                        <a href="queryads.php">
                            <i class="fa fa-search"></i> <span>查询屏蔽列表</span>
                        </a>
                    </li>
                    <!-- Audit log -->
                    ...
                    <li<?php if($scriptname === "taillog.php"){ ?> class="active"<?php } ?>>
                        <a href="taillog.php">
                            <i class="fa fa-list-ul"></i> <span>查看pihole.log</span>
                        </a>
                    </li>
                    <!-- Tail pihole-FTL.log -->
                    <li<?php if($scriptname === "taillog-FTL.php"){ ?> class="active"<?php } ?>>
                        <a href="taillog-FTL.php">
                            <i class="fa fa-list-ul"></i> <span>查看pihole-FTL.log</span>
                        </a>
                    </li>
                    <!-- Generate debug log -->
                ...
                <li<?php if($scriptname === "dns_records.php"){ ?> class="active"<?php } ?>>
                    <a href="dns_records.php">
                        <i class="fa fa-address-book"></i> <span>本地DNS记录</span>
                    </a>
                </li>
                <!-- Logout -->
                <?php
                ...
                <li>
                    <a href="?logout">
                        <i class="fa fa-user-times"></i> <span>退出登录</span>
                    </a>
                </li>
                <?php } ?>
                <?php } ?>
                ...
                <li>
                    <a href="https://pi-hole.net/donate/" rel="noopener" target="_blank">
                        <i class="fa-paypal-icon fab fa-paypal"></i> <span>捐助我们</span>
                    </a>
                </li>
                <?php if($auth){ ?>
                <!-- Help -->
